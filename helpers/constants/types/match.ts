...
export interface InfoDto {
  ...
  gameDuration: number; // In seconds or milliseconds depending on version
...
export interface ParticipantDto {
  ...
  summoner1Id: number; // Summoner spell 1
  summoner2Casts: number;
  summoner2Id: number; // Summoner spell 2
  summonerId: string;
...
export interface ChallengesDto {
  // Only including some common ones for brevity
  turretTakedowns?: number;
  takedowns?: number;
  kda?: number;
  ...
  [key: string]: number | undefined; // Allow for any additional challenge keys
}
